...
INSERT INTO `style_preset`
  (`id`, `name`, `description`, `prompt`, `demoHtml`, `userId`, `isBuiltin`, `sortOrder`, `updatedAt`)
VALUES (
  'cyber-clean',
  '科技博主',
  '深色高级感 + 青色霓虹 + 卡片化布局，适合测评、深度讲解、科技分享',
  '【视觉风格：科技博主（Cyber Clean）】
...
VALUES (
  'terminal-matrix',
  '黑客风',
  '终端控制台 + 霓虹绿 + ASCII 边框 + 闪烁光标，适合技术演示、极客内容',
  '【视觉风格：黑客风（Terminal Matrix）】
...
VALUES (
  'warm-story',
  '暖色系',
  '奶油米色 + 暖橘琥珀 + 优雅衬线 + 大量留白，适合 Vlog、生活方式、文化故事',
  '【视觉风格：暖色系（Warm Story）】
